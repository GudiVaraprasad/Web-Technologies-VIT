...
--
-- Table structure for table `employee_modified_task2`
--

CREATE TABLE `employee_modified_task2` (
...
--
-- Dumping data for table `employee_modified_task2`
--

INSERT INTO `employee_modified_task2` (`empno`, `empname`, `dob`, `doj`, `designation`, `department`, `salary`) VALUES
...
--
-- Indexes for table `employee_modified_task2`
--
ALTER TABLE `employee_modified_task2`
